<template>
  <div class="cg-wrap orientation-white manipulable">
    <div id="cg-container">
      <div id="cg-board">
        ...
        <div
          ...
          style="transform: translate(68px, 0px)"
        ></div>
        <div
          class="piece black knight"
          style="transform: translate(408px, 0px)"
        ></div>
        <div
          class="piece black rook"
          style="transform: translate(476px, 0px)"
        ></div>
        <div
          class="piece black pawn"
          style="transform: translate(0px, 68px)"
        ></div>
        <div
          class="piece black pawn"
        ...
        <div
          class="piece black pawn"
          style="transform: translate(136px, 68px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(136px, 408px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(204px, 408px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(272px, 408px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(340px, 408px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(408px, 408px)"
        ></div>
        <div
          class="piece white pawn"
          style="transform: translate(476px, 408px)"
        ></div>
        <div
          class="piece white queen"
          style="transform: translate(204px, 476px)"
        ></div>
        <div
          class="piece white king"
          style="transform: translate(272px, 476px)"
        ></div>
      </div>
    </div>
    <svg
    ...
    ><coords class="ranks"
      ><coord>1</coord><coord>2</coord><coord>3</coord><coord>4</coord
      ><coord>5</coord><coord>6</coord><coord>7</coord><coord>8</coord></coords
    ><coords class="files"
      ><coord>a</coord><coord>b</coord><coord>c</coord><coord>d</coord
      ><coord>e</coord><coord>f</coord><coord>g</coord><coord>h</coord></coords
